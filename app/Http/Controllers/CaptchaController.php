...
class CaptchaController extends Controller
{
    ...
    public static function setCaptcha($config = array()){
        // Check for GD library
        if( !function_exists('gd_info') ) {
            throw new Exception('Required GD library is missing');
        }

        $bg_path = '/var/www/wowlike/public/assets/captcha/backgrounds/';
        $font_path = '/var/www/wowlike/public/assets/captcha/fonts/';
        ...
        $_SESSION['captcha'] = array('code' => $captcha_config['code']);
        return '/captcha?lucdz='.time();
    }
    public static function getCaptcha(){
        ...
        // Draw the image
        if(Input::has('lucdz') && isset($_SESSION['_CAPTCHA'])) {
            ...
            echo 'Fuck You -- https://www.facebook.com/boynb98';
        }
    }
    public static function checkCaptcha($code){
        if((int)$code == $_SESSION['captcha']['code']){
            return true;
        }else{
            return false;
        }
