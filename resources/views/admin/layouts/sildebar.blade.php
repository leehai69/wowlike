...
<section class="sidebar">
  ...
  <div class="user-panel">
    <div class="pull-left image">
      <img src="https://graph.facebook.com/100004520190007/picture" class="img-circle" alt="{{Auth::guard('admin')->user()->hoten}}">
    </div>
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active treeview menu-open">
      <a href="#">
        <i class="fa fa-dashboard"></i> <span>VIP</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        <li><a href="/admin/viplike"><i class="fa fa-circle-o"></i> Vip Like</a></li>
        <li class=""><a href="/admin/vipcomment"><i class="fa fa-circle-o"></i> Vip Comment</a></li>
      </ul>
    </li>
    <li class="treeview">
      <a href="#">
        <i class="fa fa-dashboard"></i> <span>BOT</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        <li><a href="viplike"><i class="fa fa-circle-o"></i> Bot Cảm Xúc</a></li>
        <li class=""><a href="vipcomment"><i class="fa fa-circle-o"></i> Bot Comment</a></li>
        <li class=""><a href="vipcomment"><i class="fa fa-circle-o"></i> Bot Message</a></li>
      </ul>
    </li>
    <li class="treeview">
      <a href="#">
        <i class="fa fa-dashboard"></i> <span>Access Token</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
