...
<div class="panel panel-primary">
    <div class="panel-heading">List Access Token(1 Token 1 dòng)</div>
    <div class="panel-body"> 
        ...
        <div class="form-group text-right">
            <button class="btn btn-danger" onclick="upkhien()" id="check_token">Tiến Hành Add Access Token <i class="fa fa-arrow-right"></i></button>
        </div>
    </div>
</div>
<script>
