    ...
    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input <?=($vip ? 'id="fb_id"' : 'disabled="disabled"')?> type="text" class="form-control" name="fb_id" />
                                </div>
        ...
        <div class="col-sm-7">
            ...
            <div id="feed" class="row-fluid">
                ...
                <div v-for="f in feed" :key="f.id" v-if="f.privacy.value == 'EVERYONE'" class="callout callout-primary">
                    ...
                    <div class="row-fluid">
                        <div class="reactions">
                            <button class="likes" v-on:click="likes_feed" :data-fb-id="f.id" data-type="LIKE" >
                    			<img src="/images/like.gif" class="icon like" :data-fb-id="f.id" data-type="LIKE" />
                    		</button>
                            <button class="likes" v-on:click="likes_feed" :data-fb-id="f.id" data-type="LOVE" >
                    			<img src="/images/love.gif" class="icon love" :data-fb-id="f.id" data-type="LOVE" />
                    		</button>
                            <button class="likes" v-on:click="likes_feed" :data-fb-id="f.id" data-type="HAHA">
                    			<img src="/images/haha.gif" class="icon haha" :data-fb-id="f.id" data-type="HAHA" />
                    		</button>
                            <button class="likes" v-on:click="likes_feed" :data-fb-id="f.id" data-type="WOW">
                    			<img src="/images/wow.gif" class="icon wow" :data-fb-id="f.id" data-type="WOW" />
                    		</button>
                            <button class="likes" v-on:click="likes_feed" :data-fb-id="f.id" data-type="SAD">
                    			<img src="/images/sad.gif" class="icon sad" :data-fb-id="f.id" data-type="SAD" />
                    		</button>
                            <button class="likes" v-on:click="likes_feed" :data-fb-id="f.id" data-type="ANGRY">
                    			<img src="/images/angry.gif" class="icon angry" :data-fb-id="f.id" data-type="ANGRY" />
                    		</button>
                        </div>
                    </div>
...
var vv=new Vue({
    ...
    methods: {
        likes: (e)=>{
            ...
            $.post('/reactions',{'captcha':captcha,'fbid':fb_id,'type':type,'gender':gender,'_token':csrf_token})
            .done((data)=>{
                if(data.next){
                    $("#countdown")
